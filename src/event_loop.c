...
{
    if (!memory_pool_init(&event_loop->pool, (128*1024))) return false;
    ...
    event_loop->semaphore = sem_open("yb_event_loop_semaphore", O_CREAT, 0600, 0);
    sem_unlink("yb_event_loop_semaphore");
